...
#ifndef GUARDALO_SWIFT_H
#define GUARDALO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Guardalo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
/// <code>ASWebAuthenticationSession</code> captura la redirección final ella misma, así
...
SWIFT_CLASS("_TtC8Guardalo17IniciadorDeSesion")
@interface IniciadorDeSesion : NSObject <ASWebAuthenticationPresentationContextProviding>
